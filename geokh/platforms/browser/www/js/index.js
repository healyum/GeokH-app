...
var app = {
    ...
    initialize: function initialize() {
        ...
        // var nombreEntrepreneurs = this.entrepreneurs.length;
    ...
    showViewParcours: function showViewParcours(){
      ...
      $.ajax({
          ...
          url: 'http://'+url_test+'/api/parcours',
          data: {},
    ...
    showPtoBQS: function showPtoBQS(){
      $.ajax({
          ...
          async: false,
          contentType: "application/json; charset=utf-8",
          url: 'http://'+url_test+'/api/ptobqs/parcour/'+app.parcours,
          data: {},
          error: function(xhr, textStatus, err) {
    ...
    showPtoES: function showPtoES(){
      $.ajax({
          ...
          async: false,
          contentType: "application/json; charset=utf-8",
          url: 'http://'+url_test+'/api/ptoes/parcour/'+app.parcours,
          data: {},
          error: function(xhr, textStatus, err) {
          ...
          //permet de définir un entrepeneur a trouver de maniere aleatoire parmis tous disponibles
          var nombreEntrepreneurs = app.entrepreneurs.length;
          this.entrepreneur_aTrouver += randomIntFromInterval(1, nombreEntrepreneurs);
    ...
    showReponseBaliseView: function showReponseBaliseView() {
        ...
        // alert("nombre de réponse : "+nb_reponses);
        // alert("réponses courantes : "+reponses_courantes);
